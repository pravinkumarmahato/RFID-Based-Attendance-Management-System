...
const char *ssid = "iBall-Baton"; //WIFI NAME OR HOTSPOT
const char *password = "virendra1223"; //WIFI PASSWORD POR MOBILE HOTSPOT PASSWORD
...
void sendRfidLog(long cardid) {
  ...
  if(WiFi.status() == WL_CONNECTED) {
    ...
    http.begin("http://192.168.1.121:8012/RFIDandPHP/process.php");              
